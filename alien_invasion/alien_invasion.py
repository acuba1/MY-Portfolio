...
class AlienInvasion:
    ...
    def __init__(self):
       ...
       # self.settings.screen_height = self.screen.get.rect().height
        ...
        #create an instance to store the game statistic.
    ...
    def _update_aliens(self):
        """Check is the fleet is at and edge,Update the positions of all in the fleet"""
    ...
    def _check_events(self):        
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
            #Responding to Keypress "KEYDOWN"
    ...
    def _check_fleet_edges(self):
        """Respond appropiatelyif any aliens have reached and edge"""
        for alien in self.aliens.sprites():
    ...
    def _update_screen(self):
        ...
        for bullet in self.bullets.sprites():# add bullet to the screen
            bullet.draw_bullet()
